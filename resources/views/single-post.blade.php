                                            ...
                                            <div class="single-mega cn-col-4">
                                                ...
                                                <div class="single-blog-post small-featured-post d-flex">
                                                    <div class="post-thumb">
                                                        <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/23.jpg') }}" alt=""></a>
                                                    </div>
                                                    <div class="post-data">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-4">
                    <div class="hero-add">
                        <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/hero-add.gif') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="post-meta">
                                    ...
                                    <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center post-like--comments">
                                            <a href="#" class="post-like"><img src="{{ asset('assets/frontend/img/core-img/like.png') }}" alt=""> <span>392</span></a>
                                            <a href="#" class="post-comment"><img src="{{ asset('assets/frontend/img/core-img/chat.png') }}" alt=""> <span>10</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li class="single_comment_area">
                                    ...
                                    <div class="comment-content d-flex">
                                        ...
                                        <div class="comment-author">
                                            <img src="{{ asset('assets/frontend/img/bg-img/30.jpg') }}" alt="author">
                                        </div>
                                        <!-- Comment Meta -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="blog-sidebar-area">
                        ...
                        <div class="latest-posts-widget mb-50">
                            ...
                            <div class="single-blog-post small-featured-post d-flex">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{ asset('assets/frontend/img/bg-img/22.jpg') }}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <div class="post-meta">
